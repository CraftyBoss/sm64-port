...
const GeoLayout castle_courtyard_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_courtyard_dl_Cube_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -4038, 59, 4831, castle_courtyard_dl_Water_Plane_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
