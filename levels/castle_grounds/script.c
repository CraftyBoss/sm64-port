...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 2, 117, -901, 0, -180, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_NONE, 0, 200, -1841, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 200, -1841),
