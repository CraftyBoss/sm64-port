	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_ANIMATED_PART(1, 89, 29, 0, door_iris_DoorIris1_mesh),
				GEO_ANIMATED_PART(1, 0, 93, 0, door_iris_DoorIris2_mesh),
				GEO_ANIMATED_PART(1, -89, 29, 0, door_iris_DoorIris3_mesh),
				GEO_ANIMATED_PART(1, -55, -75, 0, door_iris_DoorIris4_mesh),
				GEO_ANIMATED_PART(1, 55, -75, 0, door_iris_DoorIris5_mesh),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
