...
#define ACT_SHOOT_CANNON               0x08000209 // (0x009 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_MORPH_BALL_TURN_AROUND     0x00008458 // (0x058 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX)
#define ACT_MORPH_BALL_GROUND          0x00008441 // (0x041 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX)
...
#define ACT_MOVING_SHOOT               0x00000446 // (0x044 | ACT_FLAG_MOVING)
...
#define ACT_MORPH_BALL_AIR             0x00000884 // (0x084 | ACT_FLAG_AIR)
#define ACT_MORPH_BALL_JUMP            0x02000896 // (0x096 | ACT_FLAG_AIR | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_IN_FPS                     0x00001373 // (0x173 | ACT_FLAG_STATIONARY | ACT_FLAG_INTANGIBLE)
