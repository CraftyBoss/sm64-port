...
#define MARIO_CAP_THROWN                0x00800000 // CUSTOM CAP THROW FLAG
...
#define ACT_THROW_CAP                  0x8800020C // (0x00C | ACT_FLAG_STATIONARY | ACT_FLAG_THROWING | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_THROW_CAP_MOVING           0x00000458 // (0x058 | ACT_FLAG_MOVING)
...
#define ACT_ROLL_BOOST                 0x0080845C // (0x05C | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ATTACKING)
...
#define ACT_POUNDJUMP                  0x01000884 // (0x084 | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_CAP_THROW_AIR              0x008008B9 // (0x0B9 | ACT_FLAG_AIR | ACT_FLAG_ATTACKING)
